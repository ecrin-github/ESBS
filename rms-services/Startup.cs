...
using rms_services.Extensions;

namespace rms_services
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "The RMS API - RMS Documentation", Version = "v1" });
                c.EnableAnnotations();
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "The RMS API - RMS Documentation (v.1)");
