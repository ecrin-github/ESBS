using System.Net;
using context_services.Extensions;
using context_services.Middleware;
...
namespace context_services
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "The RMS API - Context Documentation", Version = "v1" });
                c.EnableAnnotations();
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "The RMS API - Context Documentation (v.1)");
